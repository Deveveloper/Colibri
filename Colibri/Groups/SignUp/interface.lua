...
_M.create = function()
    ...
    local data = require('Groups.SignUp.data').get()
    ...
    local title = display.newText("Создайте аккаунт.", 0, 0, "Fonts/Ubuntu/Ubuntu-Light", 60)
    ...
    local signup_ = display.newText("Зарегистрироваться", 0, 0, "Fonts/Ubuntu/Ubuntu-Light", 35) buttongroup:insert(signup_)
